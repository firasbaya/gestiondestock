...
class interfaceEntre extends React.Component{
    constructor(props) {
        super(props);
        this.state={
        Top:0,
    ...
    renderItemEntre = ({item}) => {
      ...
      uri:'https://i.ibb.co/xDJ6XBd/Articleimage.jpg'                  }}
        ...
        <Text style={{marginVertical:10,marginLeft:20,letterSpacing:1.7,fontWeight:'bold',fontSize:20,marginLeft:8}}>{item.totalEntre}</Text>
      </View>
        </View>
          </View>
...
<FlatList
    data={this.state.dataSource.sort(function(a, b){return b.totalEntre- a.totalEntre})}

...
class DétailSortie extends React.Component{
  constructor() {
    super();
...
<TextAnimator
    ...
    <View style={{marginTop:40,backgroundColor:'white',flex:1,marginLeft:10,borderRadius:30}}>
              ...
              <View style={[globalStyles.H,{marginLeft:30,marginTop:10}]}>
                ...
                />
                <Text style={[globalStyles.sousTitre1,{color:'#ff8303'}]}>Id Article:</Text>
              </View>
              <Text style={[globalStyles.sousTitre1,{marginTop:0,marginLeft:54,color:'#31326f'}]}> {this.props.route.params.item.Id_Article} </Text>
...
<View style={[globalStyles.H,{marginLeft:30}]}>
                ...
                />
                <Text style={[globalStyles.sousTitre1,{color:'#ff8303'}]}>Quantité:</Text>
              </View>
              <Text style={[globalStyles.sousTitre1,{marginTop:0,marginLeft:54,color:'#31326f'}]}> {this.props.route.params.item.Quantité.toString()} </Text>
              <View style={{height:1,width:'100%',backgroundColor:'#ccc',marginBottom:5,marginTop:7}}></View>
<View style={[globalStyles.H,{marginLeft:30}]}>
                <Image
                      style={globalStyles.icon}
                ...
                />
                <Text style={[globalStyles.sousTitre1,{color:'#ff8303'}]}>Cin_Client:</Text>
              </View>
              <Text style={[globalStyles.sousTitre1,{marginTop:0,marginLeft:54,color:'#31326f'}]}> {this.props.route.params.item.Cin_Client} </Text>
              <View style={{height:1,width:'100%',backgroundColor:'#ccc',marginBottom:5,marginTop:7}}></View>
<View style={[globalStyles.H,{marginLeft:30}]}>
                <Image
                      style={globalStyles.icon}
                ...
                />
                <Text style={[globalStyles.sousTitre1,{color:'#ff8303'}]}>Montant Sortie:</Text>
              </View>
              <Text style={[globalStyles.sousTitre1,{marginTop:0,marginLeft:54,color:'#31326f'}]}> {this.props.route.params.item.Montant.toString()} </Text>
              <View style={{height:1,width:'100%',backgroundColor:'#ccc',marginBottom:5,marginTop:7}}></View>
<View style={[globalStyles.H,{marginLeft:30}]}>
                <Image
                      style={globalStyles.icon}

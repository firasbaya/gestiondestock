...
class DétailMagasinier extends React.Component{
  constructor() {
    super();
...
<TextAnimator
        content="️️️Modifier fiche magasinier" 
        textStyle={[globalStyles.textStyle,{color:'#ffe268',fontSize:27,fontWeight:'bold'}]}
        style={{marginTop:100,}}
        duration={800}
/>
<View style={{marginTop:40,backgroundColor:'white',flex:1,marginLeft:10,borderRadius:30}}>
    ...
    <TextInput
          ...
          <View style={[globalStyles.H,{marginLeft:30,marginTop:10}]}>
                ...
                <Text style={[globalStyles.sousTitre1,{color:'#ff8303'}]}>Téléphone:</Text>
                 ...
                 <TextInput
                  defaultValue={this.props.route.params.item.Téléphone}
                  label='Téléphone'
...
<View style={[globalStyles.H,{marginLeft:30,marginTop:10}]}>
                ...
                />
                <Text style={[globalStyles.sousTitre1,{color:'#ff8303'}]}>Mot de passe:</Text>
            </View>
...
<View style={[globalStyles.H,{marginLeft:30}]}>
              ...
              <Text style={[globalStyles.sousTitre1,{marginTop:0,marginLeft:54,color:'#31326f'}]}> {this.props.route.params.item.Téléphone} </Text>
              <View style={{height:1,width:'100%',backgroundColor:'#ccc',marginBottom:5,marginTop:7}}></View>
<View style={[globalStyles.H,{marginLeft:30}]}>
                <Image
                      style={globalStyles.icon}
    ...
    <View style={{height:1,width:'100%',backgroundColor:'#ccc',marginBottom:5,marginTop:7}}></View>
        <View style={[globalStyles.H,{marginLeft:30}]}>
              ...
              <Text style={[globalStyles.sousTitre1,{marginTop:0,marginLeft:54,color:'#31326f'}]}> {this.props.route.params.item.Password} </Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  modalText: {
    ...
    export default DétailMagasinier;
...
class listClienteee extends React.Component{
...
<SearchBar round
searchIcon={{ size: 25 }}
onChangeText={text => this.SearchFilterFunction(text)} onClear={text => this.SearchFilterFunction('')} placeholder="Tapez ici pour rechercher..." value={this.state.search}
/>
